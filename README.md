...
4. If the `Humblee` doesn't want to donate 2% fees to the pool, the smart contract triggers the `Suffering Period`, a `7 day` period where people can join the `Lottery Pool` to unfollow the `Humblee`. 
